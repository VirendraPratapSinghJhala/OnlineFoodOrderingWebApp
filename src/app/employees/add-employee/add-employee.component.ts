...
export class AddEmployeeComponent implements OnInit {
  ...
  onSubmit(){
   ...
   this.employee=new Employee(this.addForm.value.name,this.addForm.value.city,this.addForm.value.age,this.addForm.value.imagePath,this.addForm.value.mobileNumber);
